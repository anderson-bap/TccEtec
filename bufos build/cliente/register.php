...
?>
	<div class="register-cliente container">
		<h2 class="text-center">Criar conta: pessoa física</h2>
		<p class="text-center mb-3">Preencha o formulário para criar uma conta como pessoa física</p>
		<p class="text-center mb-4">Para criar uma conta como pessoa jurídica <a href="register_empresa.php">clique aqui</a></p>
